...
###############################################################################
# Fig. A1 - Static environment, no disturbances
rm(list = ls())
...
data.to.plot %>% 
  ...
  labs(y = "") +
  ggsave("figures/figA1.png", dpi = 1000, width = 6, height = 6) +
  ggsave("figures/figA1.pdf", width = 6, height = 6)


###############################################################################
# Figure A2 -- Fluctuating environment, spatially asynchronous
set.seed(47405)
disturb <- 0.00
...
data.to.plot %>% 
  ...
  theme(panel.grid = element_blank(), 
        ...
        axis.text = element_text(size = 10)) + 
  labs(y = "") +
  ggsave("figures/figA2.png", dpi = 1000, width = 6, height = 6) +
  ggsave("figures/figA2.pdf", width = 6, height = 6)
