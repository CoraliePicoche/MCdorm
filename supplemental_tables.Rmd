...
tibble(
  Taxon = map_chr(taxanames, str_replace_all, pattern =  "_", replacement =  " "), 
  Cluster = traits.fuz$clustering,
  PC1 = round(traits.scores[,1],3),
  PC2 = round(traits.scores[,2],3))

clusters <- cbind.data.frame(traits.scores, taxa.by.cluster)
